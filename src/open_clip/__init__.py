...
from .zero_shot_metadata import OPENAI_IMAGENET_TEMPLATES, SIMPLE_IMAGENET_TEMPLATES, CNAME_TEMPLATES, A_CNAME_TEMPLATES, PHOTO_TEMPLATES, IMAGENET_CLASSNAMES
